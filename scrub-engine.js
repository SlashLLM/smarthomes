...
function injectCSS() {
  ...
  .sw-stage{position:fixed;inset:0;z-index:10;pointer-events:none;transform:translate3d(0,0,0);backface-visibility:hidden;}
  .sw-scene{position:absolute;inset:0;opacity:0;overflow:hidden;will-change:opacity,transform;transform:translate3d(0,0,0);backface-visibility:hidden;}
  .sw-scene__video,.sw-scene__still{position:absolute;inset:0;width:100%;height:100%;object-fit:cover;object-position:center 42%;transform:translate3d(0,0,0);backface-visibility:hidden;}
  .sw-scene__still{will-change:transform;} .sw-scene.has-clip .sw-scene__still{opacity:0;} .sw-scene__video{z-index:1;will-change:transform;}
